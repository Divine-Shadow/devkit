    ...
    let
      ...
      systemDetails = {
        x86_64-linux = {
          ...
          codexHash = "sha256-/G4+O4Xyz31mRSDuXGan/kqhK659RoNPR+LxZf0Nb3g=";
        ...
        aarch64-linux = {
          ...
          codexHash = "sha256-l9k+Ed9y08JnctsBnm6ou3LCRlANRrmMdgg58yQDVeY=";
        ...
        in
        {
          ...
          devctl-overlay-runtime-authority-layout =
            ...
            pkgs.runCommand "devkit-devctl-overlay-runtime-authority-layout" {
              ...
              grep -Fx \
                "      command: codex --version | grep -q '0.154.0'" \
                ${devctl}/overlays/ouroboros-terraform/devkit.yaml
