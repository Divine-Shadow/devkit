...
// holdCurrentGeneration is shared verbatim by production and the rootless
// wrapper-path check. The check may substitute only kernel identity/ownership;
// it may not weaken executable, selector, or activated-generation equality.
