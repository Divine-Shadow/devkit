...
const (
	...
	controllerProductAgentRequestSchema     = "fleet-control/product-agent-local-request/v2"
	controllerProductAgentEventSchema       = "fleet-control/product-agent-local-event/v2"
